...
const CreateSchedule = () => {
    ...
    const handleInput = (data) => {
        ...
        if (data.addressType === 'R') { // 도로명 주소 값 입력
            if (data.bname !== '') {
            ...
            <form onSubmit={handleSubmit} className="form-container">
                <div className="form-group">
                    ...
                    <input type="text" value={title} 
                        onChange={(e) => setTitle(e.target.value)} placeholder="일정 이름" required />
                </div>
                <div className="form-group">
                    <label>날짜/시간 : </label>
                    <div>
                ...
                <div className="form-group">
                    ...
                    <input type="text" value={location} 
                        onChange={(e) => setLocation(e.target.value)} placeholder="모이는 위치" required />
                    <button onClick={handleComplete}>주소 검색</button>
                    {popup && 
                        <span><DaumPostcode
                        autoClose
                        onComplete={handleInput}/></span>}
                </div>
                <div className="form-group">
                    <label>설명 추가 :</label>
